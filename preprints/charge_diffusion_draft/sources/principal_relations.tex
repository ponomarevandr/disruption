...
\end{equation}
где $\vq$ -- плотность теплового потока, $[\vE, \vect{H}]$ -- плотность потока энергии электромагнитного поля, $\Div(\dt{\phi} \vxi)$ -- работа микронапряжений, $\dt{\phi} \gamma$ -- работа внешних микросил, $r$ -- работа внешних сил. Вектор $\kappa \rho \vj$, по-видимому, выражает поток энергии, связанный с диффузией заряда; он добавлен в уравнение, чтобы при дальнейшем выводе получить нужное определяющее соотношение для тока $\vj$ и положительный диапазон температуры $\theta$.
