...
Для вывода формулы $\psi^T$ будем считать, что теплоемкость среды $c = -\hat{\psi}_{\theta \theta} = -\psi^T_{\theta \theta} \hm = c(\phi)$, то есть не зависит от температуры. Тогда, интегрируя, получим
\[
