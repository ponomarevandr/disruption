...
Отметим, что величина $l = \sqrt{\lambda / \Gamma_V}$ есть масштабный коэффициент характерной толщины диффузной границы. Переобозначим $\Gamma_V = \Gamma / l^2$, $\lambda = \Gamma$; здесь параметр $\Gamma$ имеет смысл характерной энергии образования канала пробоя единичной длины (подразумевается <<площадь сечения>> $\approx l^2$).