...
\newcommand{\avlaplphi}{{\aver{\triangle \phi}}}
...
\newcommand{\bilapl}[1]{\triangle^2 #1}
...
\newcommand{\gridpartlaplphi}{{\gridfunc{(\triangle \phi)}}}
...
\newcommand{\PreprintTitle}{
	Численное исследование обобщения модели развития канала электрического пробоя типа <<диффузной границы>> при описании объектов высшей коразмерности.
...
\newcommand{\PreprintTitleEnglish}{
	...
	Numerical analysis of a generalized diffuse interface model for the electrical breakdown process in description of higher codimension objects.
}
