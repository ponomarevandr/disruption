...
\begin{itemize}
	...
	%\item Пономарев А. С., Зипунова Е. В., Савенков Е. Б. Устойчивость стационарных решений в модели развития канала электрического пробоя типа <<диффузной границы>> // Препринты ИПМ им. М. В. Келдыша.
	%\item Пономарев А. С., Зипунова Е. В., Савенков Е. Б. Численное исследование обобщения модели развития канала электрического пробоя типа <<диффузной границы>> // Препринты ИПМ им. М. В. Келдыша.
\end{itemize}
