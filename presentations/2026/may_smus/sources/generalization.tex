...
\begin{tabular}{{|%
    ...
    \hline
    плоский \linebreak случай & $\clOmega = [0, +\infty)_x \times I_y \times J_z$ & $\phi|_{x = 0} = 0$ & $\phi \to 1$ при \linebreak $r = x \to +\infty$ \\
    \hline
    цилиндрический \linebreak случай & $\clOmega = \Real_x \times \Real_y \times J_z$ & $\phi|_{x, y = 0} = 0$ & $\phi \to 1$ при \linebreak $r = \sqrt{x^2 + y^2} \to +\infty$ \\
    \hline
    сферический \linebreak случай & $\clOmega = \Real_x \times \Real_y \times \Real_z$ & $\phi|_{x, y, z = 0} = 0$ & $\phi \to 1$ при \linebreak $r = \sqrt{x^2 + y^2 + z^2} \to +\infty$ \\
    \hline
\end{tabular}
\end{center}
