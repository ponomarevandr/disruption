...
def norm_uniform_1d(values_first, values_second):
...
def norm_uniform_2d(values_first, values_second):
...
def norm_uniform(model_first, model_second):
	return norm_uniform_2d(model_first.df_phi, model_second.df_phi)

def norm_uniform_final(model_first, model_second):
	return norm_uniform_1d(model_first.df_phi.iloc[-1], model_second.df_phi.iloc[-1])
