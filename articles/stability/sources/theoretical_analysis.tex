...
Подставим решение $\phi(x, t) \equiv C$ в уравнение \eqref{eq:one_dim} и с учетом выражения \eqref{eq:epsilon_derivatives} получим:
\begin{equation}
...
Пусть $\phi(x, t)$ -- некоторое решение уравнения \eqref{eq:one_dim}, $\delta \phi(x, t)$ -- возмущение. Записав уравнение \eqref{eq:one_dim} для возмущенного решения $\phi + \delta \phi$, после линеаризации придем к следующему уравнению относительно возмущения $\delta \phi$:
\begin{equation}
...
Рассмотрим положение равновесия $\phi \equiv 0$. Имеем $f''(0) = 0, \; \epsilon''(0) = 0$ (см. выражение \eqref{eq:epsilon_derivatives}); получаем $A = 0$. Этот случай требует более глубокого анализа, назвать тип положения равновесия мы пока не можем.

Рассмотрим положение равновесия $\phi \equiv 1$. Здесь $f''(0) = -12, \; \epsilon''(0) = 12 \epsilon_0 / (1 + \delta)^2$ (см. выражение \eqref{eq:epsilon_derivatives}); получаем:
