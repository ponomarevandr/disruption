...
Данные выше условия устойчивости были выведены для упрощенного, одномерного, случая рассматриваемой задачи. Однако их главная цель~-- позволить оценить, пусть и приближенно, допустимые величины шагов $\tau$ и $h$ при моделировании задачи в~полной, трехмерной постановке.
